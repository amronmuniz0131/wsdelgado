 ...
 */
export const Placeholder = ({ className = "", text = "" }: { className?: string; text?: string }) => (
    <div className={`relative overflow-hidden bg-gray-50 border border-gray-200 ${className}`}>
