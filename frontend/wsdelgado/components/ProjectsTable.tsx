...
export function ProjectsTable() {
    ...
    const handleClose = () => {
        setOpen(false);
        setNewProject({ name: '', foreman: '', engineer: '', location: '', client: '', address: '' });
    };
                ...
                <Table sx={{ minWidth: 650 }} aria-label="projects table">
                    <TableHead className="bg-gray-50">
                        <TableRow>
                            ...
                            <TableCell className="font-semibold text-gray-600">Foreman</TableCell>
                            <TableCell className="font-semibold text-gray-600">Engineer</TableCell>
                            <TableCell className="font-semibold text-gray-600">Location</TableCell>
                            <TableCell className="font-semibold text-gray-600">Client</TableCell>
