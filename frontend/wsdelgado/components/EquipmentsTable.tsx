            ...
            <TableContainer component={Paper} className="shadow-sm border border-gray-200">
                <Table sx={{ minWidth: 650 }} aria-label="equipments table">
                    <TableHead className="bg-gray-50">
                        <TableRow>
                            <TableCell className="font-semibold text-gray-600">Equipment Name</TableCell>
                            ...
                            <TableCell className="font-semibold text-gray-600">Current Location</TableCell>
                            <TableCell className="font-semibold text-gray-600">Operator</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {equipments.map((row) => (
