      ...
      <main>
            ...
            <div className="aspect-[21/9] w-full relative mb-12">
              ...
              <div className="absolute top-1/2 left-12 -translate-y-1/2 max-w-lg bg-white/75 p-8 backdrop-blur-sm shadow-sm rounded-xl z-20">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Lorem ipsum sit o dolor amet consectetur adipiscing elit. Building your dreams with precision and excellence.
                </p>
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight uppercase">Our Services</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[{
              id: 1, name: 'demolition', image: 'https://www.capitalrecycling.com.au/wp-content/uploads/2023/02/86-Victoria-Avenue-Dalkeith-35-scaled.jpg'
            }, {
              id: 2, name: 'glassworks', image: 'https://www.schiavello.com/__data/assets/image/0015/29202/glassworks-australia-banner.jpg'
            }, {
              id: 3, name: 'renovation', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGwVRCe9gfTke8xHCvty8sbRLYxoG4yrUwgg&s'
            }].map((item) => (
              <div key={item.id} className="flex flex-col group cursor-pointer hover:scale-105 transition-transform duration-500">
                ...
                <h3 className="text-xl font-bold mb-3 capitalize">{item.name}</h3>
        ...
        <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            ...
            <div className="md:pl-10">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Stay in loop with our company news. Sign up to our newsletter and receive the freshest info about our latest projects and locations.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 aspect-square w-full">
              ...
              <img src="https://pollackpeacebuilding.com/wp-content/uploads/2024/11/construction-.jpg" alt="" className="rounded-xl w-full h-full object-contain" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gray-50/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3].map((item) => (
                <div key={item} className="bg-white p-8 border border-gray-100 shadow-sm rounded-sm text-center flex flex-col items-center">
                  <p className="text-gray-600 italic mb-6 leading-relaxed text-sm">
                    "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aene an massa."
                  </p>
